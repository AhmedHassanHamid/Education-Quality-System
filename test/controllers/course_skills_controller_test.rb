...
class CourseSkillsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_skill" do
    assert_difference('CourseSkill.count') do
      post course_skills_url, params: { course_skill: { User_id: @course_skill.User_id, course_code: @course_skill.course_code, skills: @course_skill.skills } }
    end
  ...
  test "should update course_skill" do
    patch course_skill_url(@course_skill), params: { course_skill: { User_id: @course_skill.User_id, course_code: @course_skill.course_code, skills: @course_skill.skills } }
